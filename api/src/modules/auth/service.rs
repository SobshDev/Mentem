...
impl AuthService
{
    ...
    pub async fn register(&self, credentials: super::domain::Credentials)
    ...
    pub async fn login(&self, credentials: super::domain::Credentials)
    -> Result<String, AuthError>
    {
        ...
        if !self
            .hasher
            .verify(credentials.password.as_str(), &hash_to_verify)
            .await?
        {
